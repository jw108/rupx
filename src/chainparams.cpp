...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(232, uint256("0x95ccec14097d095d9a66166066852d3f262994ded7421f09bdb9921b2632305e")); //last block with skipPoW.
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1536895013, // * UNIX timestamp of last checkpoint block
    279,        // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("dnsseed.rupx.io", "dnsseed.rupx.io"));
